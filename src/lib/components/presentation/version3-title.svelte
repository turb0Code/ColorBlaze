...
<div id="tlo" class="flex flex-col w-[22rem] lg:w-96 h-56 justify-center items-center " style={`background-color: ${accent3Color};`}>
    ...
    <div class="flex bg-white px-1 border-l-4 border-b-4 mt-2 border-pres4" style={`border-bottom: solid 4px ${accentColor}; border-left: solid 4px ${accent2Color}; color: ${accentColor};`}>Subtitle</div>
