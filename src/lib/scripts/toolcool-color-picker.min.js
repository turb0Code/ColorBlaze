...
// i modified this minified library to make it compatible with that project
// if you have to code review it, I'M SORRY :(
...
(() => {
    ...
    function ct(o) {
        var e = {
            ...
            s = !1,
            a = !1;
        return typeof o == "string" && (o = Pt(o)), typeof o == "object" && (E(o.r) && E(o.g) && E(o.b) ? (e = at(o.r, o.g, o.b), s = !0, a = String(o.r).substr(-1) === "%" ? "prgb" : "rgb") : E(o.h) && E(o.s) && E(o.v) ? (i = L(o.s), r = L(o.v), e = lt(o.h, i, r), s = !0, a = "hsv") : E(o.h) && E(o.s) && E(o.l) && (i = L(o.s), n = L(o.l), e = ht(o.h, i, n), s = !0, a = "hsl"), Object.prototype.hasOwnProperty.call(o, "a") && (t = o.a)), t = _(t), {
            ok: s,
            format: o.format || a,
    ...
    var l = function () {
        ...
        return o.prototype.isDark = function () {
            ...
            e === void 0 && (e = 6);
            for (var t = this.toHsv(), i = t.h, r = t.s, n = t.v, s = [], a = 1 / e; e--;) s.push(new o({
                h: i,
                s: r,
                v: n
            })), n = (n + a) % 1;
            ...
            for (var t = this.toHsl(), i = t.h, r = [this], n = 360 / e, s = 1; s < e; s++) r.push(new o({
                h: (i + s * n) % 360,
                s: t.s,
                l: t.l
            }));
    ...
    var J = class extends HTMLElement {
            ...
            onFieldKeyDown(t, i) {
                ...
                switch (t.key) {
                    case "ArrowUp": {
                        ...
                        if (i === "a") {
                            this.a = Math.max(0, Math.min(this.a + .01, 1)), this.$a.value = Math.round(this.a * 100).toString();
        ...
        `, this.$hex = this.shadowRoot.getElementById(`hex-${i}`), this.$r = this.shadowRoot.getElementById(`r-${r}`), this.$g = this.shadowRoot.getElementById(`g-${n}`), this.$b = this.shadowRoot.getElementById(`b-${s}`), this.$a = this.shadowRoot.getElementById(`a-${a}`), document.addEventListener(p, this.hsvChanged), document.addEventListener(f, this.hueChanged), document.addEventListener(m, this.alphaChanged)
            }
            disconnectedCallback() {
           ...
           <div class="popup">
            ...
            attributeChangedCallback(t, i, r) {
                ...
                if (t === "popup-position" && (this.popupPosition = r, this.$popup && this.$popup.classList.toggle("right", this.popupPosition === "right")), t === "color") {
                    this.color = r;
                    let w = (n = this.shadowRoot) == null ? void 0 : n.querySelector("toolcool-color-picker-saturation"),
    ...
    var Ut = {
        ...
        tt = class extends HTMLElement {
            ...
            buttonClicked(t) { return; }
            clickedOutside() { return; }
            toggle() { let t = this.state.isPopupVisible; return; }
            onKeyDown(t) { return; }
            stopPropagation(t) {
                t.stopPropagation()
            }
